...
- **Data Loading** (`load.py`)
  ...
  - `bulk_insert` — high-performance bulk loading via COPY protocol (thousands to millions of rows)
...
from .load import bulk_insert, load_query_to_memory, load_table_to_memory
from .query import execute_query, query_logs, run_multi_statement_sql_script
